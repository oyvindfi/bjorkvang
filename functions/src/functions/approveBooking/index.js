        ...
        try {
            ...
            if (!from) {
                ...
                if (existingBooking.phone) {
                    ...
                    const approvalSmsBody = `Hei ${firstName}! Din booking ${formatDate(existingBooking.date)} er godkjent. Signer leieavtalen: ${contractLink} – Bjørkvang forsamlingslokale`;
